...
public class vista_producto extends javax.swing.JFrame {
   ...
   controlador_producto cc = new controlador_producto();
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtnombr, new org.netbeans.lib.awtextra.AbsoluteConstraints(507, 62, 108, -1));
        jPanel1.add(txtstock, new org.netbeans.lib.awtextra.AbsoluteConstraints(507, 101, 108, -1));
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if(txtstock.getText().trim().isEmpty() || txtPrecio.getText().trim().isEmpty() || txtnombr.getText().trim().isEmpty()){
            ...
            p.setNombre(this.txtstock.getText());
            p.setPrecio(Double.parseDouble(this.txtPrecio.getText()));
            p.setStock((int) Double.parseDouble(this.txtnombr.getText()));
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        if (jtblProductos.getSelectedRow() >= 0) {
            ...
            this.txtstock.setText(p.getNombre());
            this.txtPrecio.setText(Double.toString(p.getPrecio()));
            this.txtnombr.setText(Double.toString(p.getStock()));
        }else{
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        Producto p = new Producto();
        p.setNombre(txtstock.getText());
        p.setPrecio( Double.parseDouble(txtPrecio.getText()));
        p.setStock((int) Double.parseDouble(txtnombr.getText()));
        cc.insertar_producto(p);
        //Para actualizar la tabla
        dt.setRowCount(0);
        cc.ListadoCategoria(dt);
